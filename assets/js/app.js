...
const ASSET_VERSION = '20260923-history-compare19-autoexports-7c5f0527b28e';
...
const SOURCE_REGISTER = {
  budgetCY: {label:'Current Year PU-wise Budget Available', fy:'2026-2027', source:'PU-BUDGET.xls', used:'OWE, Month-wise Actuals, PU Master, Trend, BP Analysis', remarks:'Repository source refreshed from PORTAL DATA on 23-Sep-2026; actual till date aligned to APR-SEP month-wise file.'},
  monthCY: {label:'Current Year PU-wise Month-wise Actuals', fy:'2026-2027', source:'PU-MONTH-ACTUAL.xls', used:'OWE, Month-wise Actuals, Trend, AI Trend, BP Analysis', remarks:'Repository source refreshed from PORTAL DATA on 23-Sep-2026; latest loaded month SEP 2026.'},
  ...
  smhBudgetCY: {label:'Department wise Budget Available', fy:'2026-2027', source:'PU-DEPT-DEMAND-SMH-BUDGET.xls', used:'Department wise', remarks:'Repository source refreshed from PORTAL DATA on 23-Sep-2026.'},
  smhMonthCY: {label:'Department wise Month-wise Actuals', fy:'2026-2027', source:'PU-DEPT-DEMAND-SMH-ACTUAL.xls', used:'Department wise', remarks:'Repository source refreshed from PORTAL DATA on 23-Sep-2026; latest loaded month SEP 2026.'},
  demandSmhCY: {label:'Demand / SMH Grant Summary', fy:'2026-2027', source:'DEMAND-SMH-BUGDET.xls + DEMAND-SMH-ACTUAL.xls', used:'Demand / SMH Summary', remarks:'Repository source refreshed from PORTAL DATA on 23-Sep-2026. Completed through AUG 2026; SEP 2026 is current running month; latest uploaded actual month detected as SEP 2026. Demand 12N/10N Suspense Heads is shown separately.'}
};
...
const DEFAULT_DATA_AS_ON_DATE = new Date('2026-09-23T23:25:18+05:30');
let _dataAsOnDate = new Date(DEFAULT_DATA_AS_ON_DATE);
const RLP_BUILD_ID = 'rlp-mbd-2026-09-23-history-compare19-7c5f0527b28e';
